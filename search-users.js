...
module.exports.main = async event => {
  ...
  const sql = `
      SELECT DISTINCT profiles.id, profiles.name,profiles.handle, profiles.avatar, profiles.company, profiles.website, profiles.location, profiles.status,
      profiles.bio, profiles.githubusername, profiles.linkedin,profiles.skills FROM profiles, educations
